export const Themes = (background_color, primary_color) => {
    return ([
        {
            "backgroundColor":`${background_color}`,
            "opacity":"0.5",
            "backgroundImage":`linear-gradient(135deg, ${primary_color} 25%, transparent 25%), linear-gradient(225deg, ${primary_color} 25%, transparent 25%), linear-gradient(45deg, ${primary_color} 25%, transparent 25%), linear-gradient(315deg, ${primary_color} 25%, ${background_color} 25%)`,
        ...
        },
        {
            "backgroundColor":`${background_color}`,
            "opacity":"0.5",
            "backgroundImage":`linear-gradient(45deg, ${primary_color} 50%, ${background_color} 50%)`,
            "backgroundSize":"22px 22px"
        },
        {
            "backgroundColor":`${background_color}`,
            "opacity":"0.5",
            "backgroundImage":`linear-gradient(-45deg, ${background_color}, ${background_color} 50%, ${primary_color} 50%, ${primary_color})`,
            "backgroundSize":"22px 22px"
        },
        {
            "backgroundColor":`${background_color}`,
            "opacity":"0.5",
            "backgroundImage":`repeating-linear-gradient(45deg, ${primary_color} 25%, transparent 25%, transparent 75%, ${primary_color} 75%, ${primary_color}), repeating-linear-gradient(45deg, ${primary_color} 25%, ${background_color} 25%, ${background_color} 75%, ${primary_color} 75%, ${primary_color})`,
